    ...
    <div className='text-gray-100 flex flex-col justify-between' style={{ height: '76px' }}>
      ...
      {navSelected !== 'Home' && (
        <div className='flex justify-between z-index-9'>
          <div className='flex'>
          <div className='flex justify-center align-items-center gap-3 ml-5 cursor-pointer'>
            <a href="https://www.kronobit.org/" target="_blank" rel="noreferrer"> <img src="/img/icons/logo.png" alt="" width="150"></img></a>
          </div>
                  ...
                  pending ? (
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className='flex justify-center align-items-center gap-3 mt-2 cursor-pointer' onClick={addTokenCallback}>
                        ...
                        <span className='fs-14'> {isMobile ? 'KNB' : 'Add KNB token to MetaMask'}</span>
                      </div>
