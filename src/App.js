...
import ProfitShare from './routes/ProfitShare';
...
function App() {
  ...
  return (
    <LocationProvider>
      <div className='app-container relative min-h-screen md:flex' style={{background: `url(/img/main-bg.png)`}}>
        {/* SIDEBAR NAV */}
        {/* {navSelected !== 'Home' && (
          ...
          >
            <PosedRouter>
              <ScrollTop path="/">
                ...
                <ProfitShare path="profitshare" setNavSelected={setNavSelected} />
